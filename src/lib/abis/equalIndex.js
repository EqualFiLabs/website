export const equalIndexFacetV3Abi = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'loanId', type: 'uint256', indexed: true },
      { name: 'borrowAsset', type: 'address', indexed: true },
      { name: 'principal', type: 'uint256', indexed: false },
      { name: 'fee', type: 'uint256', indexed: false },
      { name: 'outgoing', type: 'bool', indexed: false },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'indexId', type: 'uint256', indexed: true },
      { name: 'collateralUnits', type: 'uint256', indexed: false },
      { name: 'writtenOffPrincipalTotal', type: 'uint256', indexed: false },
    ],
    anonymous: false,
  },
  {
  ...
  {
    type: 'event',
    name: 'BorrowFeeTiersConfigured',
    inputs: [
      { name: 'indexId', type: 'uint256', indexed: true },
      { name: 'minCollateralUnits', type: 'uint256[]', indexed: false },
      { name: 'flatFeeNative', type: 'uint256[]', indexed: false },
    ],
    anonymous: false,
  },
  {
    type: 'event',
    name: 'BorrowFlatFeePaid',
    inputs: [
      { name: 'loanId', type: 'uint256', indexed: true },
      { name: 'indexId', type: 'uint256', indexed: true },
      { name: 'collateralUnits', type: 'uint256', indexed: false },
      { name: 'feeNative', type: 'uint256', indexed: false },
    ],
    anonymous: false,
  },
  {
    type: 'event',
    name: 'LoanExtendFlatFeePaid',
    inputs: [
      { name: 'loanId', type: 'uint256', indexed: true },
      { name: 'indexId', type: 'uint256', indexed: true },
      { name: 'collateralUnits', type: 'uint256', indexed: false },
      { name: 'addedDuration', type: 'uint40', indexed: false },
      { name: 'feeNative', type: 'uint256', indexed: false },
    ],
    anonymous: false,
  },
  ...
  {
    type: 'function',
    name: 'configureBorrowFeeTiers',
    inputs: [
      { name: 'indexId', type: 'uint256', internalType: 'uint256' },
      { name: 'minCollateralUnits', type: 'uint256[]', internalType: 'uint256[]' },
      { name: 'flatFeeNative', type: 'uint256[]', internalType: 'uint256[]' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
