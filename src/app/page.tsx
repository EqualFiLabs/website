      ...
      <header className="border-b border-white/20 p-4 flex justify-between items-center bg-black sticky top-0 z-50">
        ...
        <nav className="hidden md:flex gap-8 text-sm uppercase tracking-widest items-center">
          <div className="flex gap-4">
            <a href="https://discord.gg/your-invite" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity" aria-label="Discord">
            ...
            <a href="https://t.me/your-channel" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity" aria-label="Telegram">
            ...
            <a href="https://matrix.to/#/@your-user:matrix.org" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity" aria-label="Matrix">
